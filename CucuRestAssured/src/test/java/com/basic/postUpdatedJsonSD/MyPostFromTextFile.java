...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\Users\\suruchi.k\\WorkSpace\\CucuRestAssured\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json"))); 
	    System.out.println("json in String ==== " +data);
	    
	    //Update the data
	    JSONObject object=new JSONObject(data);
	    
	    //using timeStamp we are creating unique record in the DB
